...
import { getNotifcationContent, getNotifcationVisibilty } from '../jsvars/notification.ts'
...
const notificationcontent = computed(() => {
    return getNotifcationContent();
})

const notificationHidden = computed(() => {
    return getNotifcationVisibilty();
})
...
<template >
    <div class="">
        <div class="mobile:h-0 mobile:absolute">
            <Notification v-if="notificationHidden.value">{{ notificationcontent.value }}
            </Notification>
        </div>
        <div class="shrink pt-2 pr-4" style="height: 105vh;">
            <div class="flex grow gap-2 grid-cols-2 pl-3 pb-3 md:h-5/6 mobile:h-4/5">
                ...
                <div id="messagecontainer"
                    ...
                    <div class="pb-5">
                        <div v-if="messagepage" v-for="messsage in getmessages().value" :key="messsage.msgid"
                            ref="messageDiv">
